      ...
      return function (event) {
        ...
        if (dragAnimation === flowchartConstants.dragAnimationShadow) {
          if (edgeDragging.gElement === undefined) {
            ...
            // IE Support
            edgeDragging.gElement = jquery(document.querySelectorAll('.shadow-svg-class'))
            edgeDragging.pathElement = jquery(document.querySelectorAll('.shadow-svg-class')).find('path')
            edgeDragging.circleElement = jquery(document.querySelectorAll('.shadow-svg-class')).find('circle')
          }
...
export default Edgedraggingfactory(null, flowchartConstants, EdgedrawingService)
