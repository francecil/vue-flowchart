...
function ModelFactory (Modelvalidation) {
  return function innerModelfactory (model, selectedObjects, dropNode, createEdge, edgeAddedCallback, nodeRemovedCallback, edgeRemovedCallback) {
    ...
    modelservice.dropNode = dropNode || noop
    modelservice.createEdge = createEdge || function () { return Promise.resolve({ label: 'label' }) }
    modelservice.edgeAddedCallback = edgeAddedCallback || noop
    modelservice.nodeRemovedCallback = nodeRemovedCallback || noop
    modelservice.edgeRemovedCallback = edgeRemovedCallback || noop
    ...
    modelservice.selectAllInRect = function (rectBox) {
      model.nodes.forEach(function (value) {
      ...
      model.edges.forEach(function (value) {
...
export default ModelFactory(Modelvalidation)
